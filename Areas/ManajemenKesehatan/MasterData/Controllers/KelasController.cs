...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.MasterData.Controllers
{
    ...
    public class KelasController : Controller
    {
        ...
        public KelasController(
            ...
            ILogger<KelasController> logger,
        ...
        [HttpGet]
        public async Task<IActionResult> GetAllKelas(int page = 1, int perPage = 10)
        {
            ...
            // Query data
            var query = from a in _applicationDbContext.Kelass
                        ...
                        select new
                        {
                            ...
                            KelasId = a.KelasId,
                            KodeKelas = a.KodeKelas,
                            NamaKelas = a.NamaKelas,
                            DeskripsiKelas = a.DeskripsiKelas,
                        };
        ...
        {
            var listdata = _applicationDbContext.Kelass.Find(id);
            if (listdata == null)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateKelas([FromBody] KelasViewModel vm)
        {
        ...
        public async Task<IActionResult> UpdateKelas(Guid id, [FromBody] KelasViewModel vm)
        {
            ...
            try
            {
                ...
                // **Cari Data**
                var data = await _applicationDbContext.Kelass.FindAsync(id);
                if (data == null)
                {
                    return NotFound(new { message = "Data tidak ditemukan." });
                }
                ...
                data.DeskripsiKelas = vm.DeskripsiKelas;
                ...
                var isDuplicate = await _applicationDbContext.Kelass
                    .AnyAsync(t => t.NamaKelas.ToLower().Trim() == vm.NamaKelas.ToLower().Trim() && t.KelasId != id);
                if (isDuplicate)
                {
                    return Conflict(new { message = "Kelas dengan nama tersebut sudah ada!" });
                }

                _applicationDbContext.Kelass.Update(data);
                int result = await _applicationDbContext.SaveChangesAsync();
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteKelas(Guid id)
        {
            try
            {
                // **Cek koneksi ke database**
        ...
        [HttpGet("paged")]
        public IActionResult PagedKelas(
        int page = 1,
        int perPage = 10,
        string? search = null,
        ...
        [FromQuery, JsonConverter(typeof(StringEnumConverter))] PeriodeFilter? periode = null)
        {
            ...
            if (!string.IsNullOrWhiteSpace(search))
            {
                ...
                query = query.Where(u =>
                    ...
                    EF.Functions.ILike(u.DeskripsiKelas, search)
                );
            }
            ...
            query = sortDirection?.ToLower() == "desc"
                ? orderBy switch
                {
                    ...
                    "DeskripsiKelas" => query.OrderByDescending(u => u.DeskripsiKelas),
