...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.MasterData.Controllers
{
    ...
    public class TitleController : Controller
    {
        ...
        public async Task<IActionResult> GetAllTitle(int page = 1, int perPage = 10)
        {
            ...
            // Query data
            var query = from a in _applicationDbContext.Titles
                        ...
                        select new
                        {
                            ...
                            TitleId = a.TitleId,
                            KodeTitle = a.KodeTitle,
                            NamaTitle = a.NamaTitle,
                        };
        ...
        public async Task<IActionResult> CreateTitle([FromBody] TitleViewModel vm)
        {
            ...
            try
            {
                ...
                var isDuplicate = _applicationDbContext.Titles
                    .Any(c => c.KodeTitle == kode && c.NamaTitle == vm.NamaTitle && c.IsDelete == false);
        ...
        [FromQuery, JsonConverter(typeof(StringEnumConverter))] PeriodeFilter? periode = null)
        {
            ...
            {
                query = query.Where(u =>
                    u.KodeTitle.Contains(search) || u.NamaTitle.Contains(search)
                );
            }
            ...
            query = sortDirection?.ToLower() == "desc"
                ? orderBy switch
                {
                    ...
                    "KodeTitle" => query.OrderByDescending(u => u.KodeTitle),
                    "NamaTitle" => query.OrderByDescending(u => u.NamaTitle),
                ...
                : orderBy switch
                {
                    ...
                    "KodeTitle" => query.OrderBy(u => u.KodeTitle),
                    "NamaTitle" => query.OrderBy(u => u.NamaTitle),
