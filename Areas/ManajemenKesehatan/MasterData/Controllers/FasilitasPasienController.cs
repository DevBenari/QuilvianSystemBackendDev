    ...
    public class FasilitasPasienController : Controller
    {
        ...
        public async Task<IActionResult> Create([FromBody] FasilitasPasienViewModel vm)
        {
            ...
            try
            {
                ...
                // Cek Duplikasi
                var isDuplicate = await _context.FasilitasPasiens
                    .AnyAsync(c => c.NamaFasilitasPasien.ToLower().Trim() == vm.NamaFasilitasPasien.ToLower().Trim());
        ...
        [FromQuery, JsonConverter(typeof(StringEnumConverter))] PeriodeFilter? periode = null)
        {
            ...
            if (!string.IsNullOrWhiteSpace(search))
            {
                ...
                query = query.Where(u =>
                    EF.Functions.ILike(u.KodeFasilitas, search) ||
                    EF.Functions.ILike(u.NamaFasilitasPasien, search)
                );
            }
