    ...
    public class DepartementController : Controller
    {
        ...
        public async Task<IActionResult> CreateDepartement([FromBody] DepartementViewModel vm)
        {
            ...
            try
            {
                ...
                var isDuplicate = _applicationDbContext.Departements
                    .Any(c =>c.NamaDepartement.ToLower().Trim() == vm.NamaDepartement.ToLower().Trim() && c.IsDelete == false);
        ...
        [FromQuery, JsonConverter(typeof(StringEnumConverter))] PeriodeFilter? periode = null)
        {
            ...
            if (!string.IsNullOrWhiteSpace(search))
            {
                ...
                query = query.Where(u =>
                    EF.Functions.ILike(u.KodeDepartement, search) ||
                    EF.Functions.ILike(u.NamaDepartement, search)
                );
            }
