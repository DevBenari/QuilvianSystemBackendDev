...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.MasterData.Controllers
{
    ...
    public class GudangUnitController : Controller
    {
        private readonly ApplicationDbContext _applicationDbContext;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly SignInManager<ApplicationUser> _signInManager;

        private readonly ILogger<GudangUnitController> _logger;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public GudangUnitController(
            ApplicationDbContext applicationDbContext,
            UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager,
            ILogger<GudangUnitController> logger,
        ...
        public async Task<IActionResult> GetAll(int page = 1, int perPage = 10)
        {
            ...
            // Query data
            var query = (from a in _applicationDbContext.GudangUnits
        ...
        {
            var listdata = _applicationDbContext.GudangUnits.Find(id);
            if (listdata == null)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] GudangUnitViewModel vm)
        {
            ...
            try
            {
                ...
                // **Simpan ke Database**
                _applicationDbContext.GudangUnits.Add(data);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] GudangUnitViewModel vm)
        {
            if (vm == null || !ModelState.IsValid)
            {
                return BadRequest(new { message = "Data tidak valid." });
            ...
            try
            {
                ...
                // **Cari Data**
                var data = await _applicationDbContext.GudangUnits.FindAsync(id);
                if (data == null)
                {
                    return NotFound(new { message = "Data tidak ditemukan." });
                }
                ...
                _applicationDbContext.GudangUnits.Update(data);
                int result = await _applicationDbContext.SaveChangesAsync();
