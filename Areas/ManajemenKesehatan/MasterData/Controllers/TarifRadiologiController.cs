...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.MasterData.Controllers
{
    ...
    public class TarifRadiologiController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] TarifRadiologiViewModel vm)
        {
            ...
            try
            {
                ...
                // **Buat Data Baru**
                var data = new TarifRadiologi
                {
                    TarifRadId = Guid.NewGuid(),
                ...
                // **Simpan ke Database**
                _applicationDbContext.TarifRadiologis.Add(data);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] TarifRadiologiViewModel vm)
        {
            if (vm == null || !ModelState.IsValid)
            {
                return BadRequest(new { message = "Data tidak valid." });
            ...
            try
            {
                ...
                // **Cari Data**
                var data = await _applicationDbContext.TarifRadiologis.FindAsync(id);
                if (data == null)
                {
                    return NotFound(new { message = "Data tidak ditemukan." });
                }
                ...
                _applicationDbContext.TarifRadiologis.Update(data);
                int result = await _applicationDbContext.SaveChangesAsync();
            ...
            [FromQuery, JsonConverter(typeof(StringEnumConverter))] PeriodeFilter? periode = null)
        {
            ...
            // Query data
            var query = (from a in _applicationDbContext.TarifRadiologis.AsNoTracking()
                         join u in _applicationDbContext.UserActives.AsNoTracking()
                             on a.CreateBy equals u.UserActiveId into uG
                         from u in uG.DefaultIfEmpty()
