...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.MasterData.Controllers
{
    ...
    public class JenisObatController : Controller
    {
        ...
        private readonly ILogger<JenisObatController> _logger;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public JenisObatController(
            ApplicationDbContext applicationDbContext,
            UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager,
            ILogger<JenisObatController> logger,
        ...
        public async Task<IActionResult> Create([FromBody] JenisProkesViewModel vm)
        {
            ...
            try
            {
                ...
                if (isDuplicate)
                {
                    return Conflict(new { message = "Nama jenis produk obat ini telah tersedia" });
                }
