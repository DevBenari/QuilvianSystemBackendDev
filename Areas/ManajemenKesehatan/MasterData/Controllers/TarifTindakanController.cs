...
//        private readonly ILogger<TarifTindakanController> _logger;
//        private readonly IWebHostEnvironment _webHostEnvironment;

//        public TarifTindakanController(
//            ApplicationDbContext applicationDbContext,
//            UserManager<ApplicationUser> userManager,
//            SignInManager<ApplicationUser> signInManager,
//            ILogger<TarifTindakanController> logger,
...
//        [HttpPost]
//        public async Task<IActionResult> CreateTarifTindakan([FromBody] TarifTindakanViewModel vm)
//        {
...
//        [HttpPut("{id}")]
//        public async Task<IActionResult> UpdateTarifTindakan(Guid id, [FromBody] TarifTindakanViewModel vm)
//        {
//            if (vm == null || !ModelState.IsValid)
//            {
//                return BadRequest(new { message = "Data tidak valid." });
