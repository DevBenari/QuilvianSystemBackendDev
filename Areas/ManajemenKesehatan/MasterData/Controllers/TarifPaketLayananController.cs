...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.MasterData.Controllers
{
    ...
    public class TarifPaketLayananController : Controller
    {
        private readonly ApplicationDbContext _applicationDbContext;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly SignInManager<ApplicationUser> _signInManager;

        private readonly ILogger<TarifPaketLayananController> _logger;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public TarifPaketLayananController(
            ApplicationDbContext applicationDbContext,
            UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager,
            ILogger<TarifPaketLayananController> logger,
        ...
        public async Task<IActionResult> GetById(Guid id)
        {
            var listdata = (from a in _applicationDbContext.TarifPaketLayanans.AsNoTracking()
                            ...
                            where a.IsDelete == false && a.TarifPaketLayananId == id
                            select new
                            {
                                a.CreateDateTime,
                                a.CreateBy,
                                CreateByName = u.FullName,
                                a.TarifPaketLayananId,
                                a.PaketLayananId,
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] TarifPaketLayananViewModel vm)
        {
            ...
            try
            {
                ...
                // **Buat Data Baru**
                var data = new TarifPaketLayanan
                {
                    TarifPaketLayananId = Guid.NewGuid(),
                ...
                // **Simpan ke Database**
                _applicationDbContext.TarifPaketLayanans.Add(data);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] TarifPaketLayananViewModel vm)
        {
            if (vm == null || !ModelState.IsValid)
            {
                return BadRequest(new { message = "Data tidak valid." });
            ...
            try
            {
                ...
                // **Cari Data**
                var data = await _applicationDbContext.TarifPaketLayanans.FindAsync(id);
                if (data == null)
                {
                    return NotFound(new { message = "Data tidak ditemukan." });
                }
                ...
                _applicationDbContext.TarifPaketLayanans.Update(data);
                int result = await _applicationDbContext.SaveChangesAsync();
        ...
        [FromQuery, JsonConverter(typeof(StringEnumConverter))] PeriodeFilter? periode = null)
        {
            ...
            if (!string.IsNullOrWhiteSpace(search))
            {
                ...
                query = query.Where(u =>
                    EF.Functions.ILike(u.NamaPaketLayanan, search) ||
            ...
            if (paketLayananId.HasValue)
            {
                query = query.Where(u => u.PaketLayananId == paketLayananId.Value);
            }
