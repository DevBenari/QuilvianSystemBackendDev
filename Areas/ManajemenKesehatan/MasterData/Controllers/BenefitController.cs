...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.MasterData.Controllers
{
    ...
    public class BenefitController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAllBenefits(int page = 1, int perPage = 10)
        {
            ...
            var query = (from a in _applicationDbContext.Benefits
                         ...
                         select new
                         {
                             ...
                             NamaBenefit = a.NamaBenefit,
                             Keterangan = a.Keterangan,
                             BiayaBenefit = a.BiayaBenefit,
                             IsAktif = a.IsAktif,
        ...
        {
            var listdata = _applicationDbContext.Benefits.Find(id);
            if (listdata == null)
            {
        ...
        public async Task<IActionResult> Create([FromBody] BenefitViewModel vm)
        {
            ...
            try
            {
                ...
                // **Buat Data Baru**
                var data = new Benefit
                {
                    BenefitId = Guid.NewGuid(),
                    NamaBenefit = vm.NamaBenefit,
                    Keterangan = vm.Keterangan,
                    BiayaBenefit = vm.BiayaBenefit,
                    IsAktif = vm.IsAktif,
                ...
                // **Simpan ke Database**
                _applicationDbContext.Benefits.Add(data);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] BenefitViewModel vm)
        {
            if (vm == null || !ModelState.IsValid)
            {
                return BadRequest(new { message = "Data tidak valid." });
            ...
            try
            {
                ...
                // **Cari Data**
                var data = await _applicationDbContext.Benefits.FindAsync(id);
                if (data == null)
                {
                    return NotFound(new { message = "Data tidak ditemukan." });
                }
                ...
                // **Update Data**
                data.NamaBenefit = vm.NamaBenefit;
                data.Keterangan = vm.Keterangan;
                data.BiayaBenefit = vm.BiayaBenefit;
                data.IsAktif = vm.IsAktif;

                data.UpdateBy = userActiveId;
                data.UpdateDateTime = DateTimeOffset.UtcNow;

                _applicationDbContext.Benefits.Update(data);
                int result = await _applicationDbContext.SaveChangesAsync();
