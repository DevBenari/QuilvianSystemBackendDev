    ...
    public class MeasurementController : Controller
    {
        ...
        public async Task<IActionResult> CreateMeasure([FromBody] MeasurementViewModel vm)
        {
            ...
            try
            {
                ...
                // Cek Duplikasi
                var isDuplicate = await _applicationDbContext.Measurements
                    .AnyAsync(c => c.NamaMeasurement.ToLower().Trim() == vm.NamaMeasurement.ToLower().Trim() && c.IsDelete == false);
        ...
        public async Task<IActionResult> UpdateMeasure(Guid id, [FromBody] MeasurementViewModel vm)
        {
            ...
            try
            {
                ...
                // Cek Duplikasi
                var isDuplicate = await _applicationDbContext.Measurements
                    .AnyAsync(c => c.NamaMeasurement.ToLower().Trim() == vm.NamaMeasurement.ToLower().Trim() && c.IsDelete == false && c.MeasurementId!= id);
