...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.Farmasi.Controllers
{
    ...
    public class CatatanESOController : Controller
    {
        ...
        public async Task<IActionResult> GetAll(int page = 1, int perPage = 10)
        {
            ...
            var query = (from a in _applicationDbContext.CatatanESOs
                         ...
                         join cpo in _applicationDbContext.CttPemberianObats
                             on a.CttPemberianObatId equals cpo.CttPemberianObatId into cpoJoin
                         from cpo in cpoJoin.DefaultIfEmpty()
        ...
        {
            var data = await (from a in _applicationDbContext.CatatanESOs
                              join u in _applicationDbContext.UserActives
                                  on a.CreateBy equals u.UserActiveId into userJoin
                              from u in userJoin.DefaultIfEmpty()
                              ...
                              where (a.IsDelete == false || a.IsDelete == null) && a.ESOId == id
                              select new
                              {
                                  a.CreateDateTime,
                                  a.CreateBy,
