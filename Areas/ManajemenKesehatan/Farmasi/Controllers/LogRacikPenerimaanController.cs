...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.Farmasi.Controllers
{
    ...
    public class LogRacikPenerimaanController : Controller
    {
        private readonly ApplicationDbContext _applicationDbContext;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly SignInManager<ApplicationUser> _signInManager;

        private readonly ILogger<LogRacikPenerimaanController> _logger;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public LogRacikPenerimaanController(
            ApplicationDbContext applicationDbContext,
            UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager,
            ILogger<LogRacikPenerimaanController> logger,
        ...
        public async Task<IActionResult> GetAll(int page = 1, int perPage = 10)
        {
            ...
            // Query data
            var query = (from a in _applicationDbContext.LogRacikPenerimaans
                         ...
                         select new
                         {
                             ...
                             a.LogPeracikanPenerimaanId,
                             a.KunjunganId,
                             a.ResepId,
                             a.UserActiveFarmasiId,
                             a.NamaFarmasi,
                             a.TglPeracikan,
        ...
        {
            var listdata = _applicationDbContext.LogRacikPenerimaans.Find(id);
            if (listdata == null)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] LogRacikPenerimaanViewModel vm)
        {
            ...
            try
            {
                ...
                // **Buat Data Baru**
                var data = new LogRacikPenerimaan
                {
                    LogPeracikanPenerimaanId = Guid.NewGuid(),
                ...
                // **Simpan ke Database**
                _applicationDbContext.LogRacikPenerimaans.Add(data);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] LogRacikPenerimaanViewModel vm)
        {
            if (vm == null || !ModelState.IsValid)
            {
                return BadRequest(new { message = "Data tidak valid." });
            ...
            try
            {
                ...
                // **Cari Data**
                var data = await _applicationDbContext.LogRacikPenerimaans.FindAsync(id);
                if (data == null)
                {
                    return NotFound(new { message = "Data tidak ditemukan." });
                }
                ...
                _applicationDbContext.LogRacikPenerimaans.Update(data);
                int result = await _applicationDbContext.SaveChangesAsync();
        ...
        [FromQuery, JsonConverter(typeof(StringEnumConverter))] PeriodeFilter? periode = null)
        {
            ...
            if (!string.IsNullOrWhiteSpace(search))
            {
                ...
                query = query.Where(u =>
                    EF.Functions.ILike(u.NamaFarmasi, search)
                );
            }
            ...
            query = sortDirection?.ToLower() == "desc"
                ? orderBy switch
                {
                    ...
                    "NamaFarmasi" => query.OrderByDescending(u => u.NamaFarmasi),
                ...
                : orderBy switch
                {
                    ...
                    "NamaFarmasi" => query.OrderBy(u => u.NamaFarmasi),
