    ...
    public class LabHasilController : Controller
    {
        ...
        public async Task<IActionResult> GetAll(int page = 1, int perPage = 10)
        {
            ...
            var query = (from a in _applicationDbContext.LabHasils
                         ...
                         select new
                         {
                             ...
                             a.RiwayatPenyakit,
                             a.FiksasiDigunakan,
                             a.PolaTujuanPengambilan,
                             a.BahanNonGinekologi,
        ...
        public async Task<IActionResult> Create([FromBody] LabHasilViewModel vm)
        {
            ...
            try
            {
                ...
                var data = new LabHasil
                {
                    ...
                    //Kategori pemeriksaan PA
                    KategoriPemeriksaanPA = vm.KategoriPemeriksaanPA,
                    JenisPemeriksaan = vm.JenisPemeriksaan,
                    LokasiSpecimen = vm.LokasiSpecimen,
                    KeteranganKlinis = vm.KeteranganKlinis,
                    JenisSpecimen = vm.JenisSpecimen,
                    MasaHaidTerakhir = vm.MasaHaidTerakhir,
                    DiagnosaKlinis = vm.DiagnosaKlinis,
        ...
        public async Task<IActionResult> Update(Guid id, [FromBody] LabHasilViewModel vm)
        {
            ...
            try
            {
                ...
                data.DokterLuarRS = vm.DokterLuarRS;
                ...
                data.KategoriPemeriksaanPA = vm.KategoriPemeriksaanPA;
                data.JenisPemeriksaan = vm.JenisPemeriksaan;
                data.LokasiSpecimen = vm.LokasiSpecimen;
                data.KeteranganKlinis = vm.KeteranganKlinis;
                data.JenisSpecimen = vm.JenisSpecimen;
                data.MasaHaidTerakhir = vm.MasaHaidTerakhir;
                data.DiagnosaKlinis = vm.DiagnosaKlinis;
            ...
            CancellationToken ct = default)
        {
                ...
                return Ok(new
                {
                    ...
                    data = new
                    {
                        Rows = parentRows.Select(p => new
                        {
                            ...
                            p.RiwayatPenyakit,
                            p.FiksasiDigunakan,
                            p.PolaTujuanPengambilan,
                            p.BahanNonGinekologi,
            ...
            var detailRaw = await (
                ...
                select new
                {
                    ...
                    d.SatuanPemeriksaan,
                    d.InfoNReff,
                    d.DetailDiagnosaKlinis,
                    d.ReseptorEstrogenER,
                    d.ReseptorProgesteronPR,
                    d.HER,
                    d.Ki67,
                    d.StatusER,
                    d.StatusPR,
                    d.HERImunohistokimia,
                    d.StatusHasil,
                    d.HasilPemeriksaan,
					d.LainLain,
                    d.Kondisi,
                ...
                .Select(x =>
                {
                    ...
                    return new
                    {
                        ...
                        Row = new
                        {
                            ...
                            x.SatuanPemeriksaan,
                            x.InfoNReff,
                            x.DetailDiagnosaKlinis,
                            x.ReseptorEstrogenER,
                            x.ReseptorProgesteronPR,
                            x.HER,
                            x.Ki67,
                            x.StatusER,
                            x.StatusPR,
                            x.HERImunohistokimia,
							x.StatusHasil,
							x.HasilPemeriksaan,
							x.LainLain,
                            x.Kondisi,
