...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.Laboratorium.Controllers
{
    ...
    public class LabController : Controller
    {
        ...
        public async Task<IActionResult> GetAll(int page = 1, int perPage = 10)
        {
            ...
            // Query data
            var query = (from a in _applicationDbContext.Labs
        ...
        {
            var listdata = _applicationDbContext.Labs.Find(id);
            if (listdata == null)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] LabViewModel vm)
        {
            ...
            try
            {
                ...
                // **Simpan ke Database**
                _applicationDbContext.Labs.Add(data);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] LabViewModel vm)
        {
            if (vm == null || !ModelState.IsValid)
            {
                return BadRequest(new { message = "Data tidak valid." });
            ...
            try
            {
                ...
                // **Cari Data**
                var data = await _applicationDbContext.Labs.FindAsync(id);
                if (data == null)
                {
                    return NotFound(new { message = "Data tidak ditemukan." });
                }
                ...
                // **Update Data**
                data.NamaLab = vm.NamaLab;
                data.Keterangan = vm.Keterangan;
                data.KodeKategori = vm.KodeKategori;
                data.UpdateBy = userActiveId;
                data.UpdateDateTime = DateTimeOffset.UtcNow;

                _applicationDbContext.Labs.Update(data);
                int result = await _applicationDbContext.SaveChangesAsync();
