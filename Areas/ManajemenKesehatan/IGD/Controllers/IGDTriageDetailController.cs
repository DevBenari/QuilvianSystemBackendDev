...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.IGD.Controllers
{
    ...
    public class IGDTriageDetailController : Controller
    {
        private readonly ApplicationDbContext _applicationDbContext;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly SignInManager<ApplicationUser> _signInManager;

        private readonly ILogger<IGDTriageDetailController> _logger;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public IGDTriageDetailController(
            ApplicationDbContext applicationDbContext,
            UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager,
            ILogger<IGDTriageDetailController> logger,
        ...
        public async Task<IActionResult> GetAll(int page = 1, int perPage = 10)
        {
            ...
            // Query data
            var query = (from a in _applicationDbContext.IGDTriageDetails
        ...
        {
            var listdata = _applicationDbContext.IGDTriageDetails.Find(id);
            if (listdata == null)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] IGDTriageDetailViewModel vm)
        {
            ...
            try
            {
                ...
                // **Buat Data Baru**
                var data = new IGDTriageDetail
                {
                    DetailTriageId = Guid.NewGuid(),
                    TriageId = vm.TriageId,
                ...
                // **Simpan ke Database**
                _applicationDbContext.IGDTriageDetails.Add(data);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] IGDTriageDetailViewModel vm)
        {
            if (vm == null || !ModelState.IsValid)
            {
                return BadRequest(new { message = "Data tidak valid." });
            ...
            try
            {
                ...
                // **Cari Data Lama**
                var data = await _applicationDbContext.IGDTriageDetails.FindAsync(id);
                if (data == null)
                {
                ...
                _applicationDbContext.IGDTriageDetails.Update(data);
                int result = await _applicationDbContext.SaveChangesAsync();
