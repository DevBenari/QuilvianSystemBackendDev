...
namespace QuilvianSystemBackendDev.Areas.ManajemenKesehatan.IGD.Controllers
{
    ...
    public class UlkusDebitusController : Controller
    {
        private readonly ApplicationDbContext _applicationDbContext;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly SignInManager<ApplicationUser> _signInManager;

        private readonly ILogger<UlkusDebitusController> _logger;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public UlkusDebitusController(
            ApplicationDbContext applicationDbContext,
            UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager,
            ILogger<UlkusDebitusController> logger,
        ...
        public async Task<IActionResult> GetAll(int page = 1, int perPage = 10)
        {
            ...
            // Query data
            var query = (from a in _applicationDbContext.UlkusDebituss
                         ...
                         select new
                         {
                             ...
                             a.KunjunganId,
                             a.PasienId,
                             a.TglAwalTirahBaring,
                             a.TglAkhirTirahBaring,
                             a.TglDekubitus,
                             a.AsalDekubitus,
        ...
        {
            var listdata = _applicationDbContext.UlkusDebituss.Find(id);
            if (listdata == null)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] UlkusDebitusViewModel vm)
        {
            ...
            try
            {
                ...
                // **Buat Data Baru**
                var data = new UlkusDebitus
                {
                    UlkusDekubitusId = Guid.NewGuid(),
                    KunjunganId = vm.KunjunganId,
                    PasienId = vm.PasienId,
                    TglAwalTirahBaring = vm.TglAwalTirahBaring,
                    TglAkhirTirahBaring = vm.TglAkhirTirahBaring,
                ...
                // **Simpan ke Database**
                _applicationDbContext.UlkusDebituss.Add(data);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] UlkusDebitusViewModel vm)
        {
            if (vm == null || !ModelState.IsValid)
                return BadRequest(new { message = "Data tidak valid." });
            ...
            try
            {
                ...
                var data = await _applicationDbContext.UlkusDebituss
                    .FirstOrDefaultAsync(x => x.UlkusDekubitusId == id &&
                ...
                data.TglAwalTirahBaring = vm.TglAwalTirahBaring;
                data.TglAkhirTirahBaring = vm.TglAkhirTirahBaring;
                ...
                if (result > 0)
                    return Ok(new { message = "Update Data Ulkus Dekubitus Berhasil || 200 OK" });
        ...
        public async Task<IActionResult> Delete(Guid id)
        {
            try
            {
                ...
                // **Cari Data**
                var data = await _applicationDbContext.UlkusDebituss.FindAsync(id);
                if (data == null)
                {
                    return NotFound(new { message = "Data tidak ditemukan." });
                }
                ...
                _applicationDbContext.UlkusDebituss.Update(data);
                int result = await _applicationDbContext.SaveChangesAsync();
