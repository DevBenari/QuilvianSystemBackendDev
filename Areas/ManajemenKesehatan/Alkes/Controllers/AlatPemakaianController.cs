...
//                    var alatDb = await _applicationDbContext.Peralatans
//                        .Where(x => x.PeralatanId == alatId)
//                        .Select(x => new { x.NamaPeralatan})
//                        .FirstOrDefaultAsync();
...
//                    var subTotal = d.TotalPemakaianAlat ?? (harga * qtyInput);

//                    // ---- DETAIL ----
//                    detailEntities.Add(new AlatPemakaianDetail
//                    {
//                        DetailPemakaianAlatId = Guid.NewGuid(),
//                        AlatPemakaianId = alatPemakaianId,
//                        PeralatanId = alatId,
//                        QtyPemakaian = qtyInput,
//                        HargaPeralatan = harga,
...
//                            ItemId = alatId,
//                            NamaItem = alatDb.NamaPeralatan,

//                            HargaItem = harga,
//                            QtyItem = qtyInput,
//                            SubTotalItem = harga * qtyInput,
