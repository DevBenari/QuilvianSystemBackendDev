    ...
    public class KasirTebusResepController : Controller
    {
        ...
        public async Task<IActionResult> GetAll(int page = 1, int perPage = 10)
        {
            ...
            var query = (from a in _applicationDbContext.KasirTebusReseps
                         ...
                         select new
                         {
                             ...
                             KasirTebusResepId = a.KasirTebusResepId,
                             NoRegistrasi = a.NoRegistrasi,
        ...
        public async Task<IActionResult> GetBillingResepTebusById(Guid ResepTebusId)
        {
            ...
            var kasirData = result.GroupBy(x => x.ktr.KasirTebusResepId).Select(group => {
                ...
                return new
                {
                    KasirTebusResepId = firstItem.ktr?.KasirTebusResepId,
                    NoRegistrasi = firstItem.ktr?.NoRegistrasi,
                    NoAntrian = firstItem.ktr?.NoAntrian,
                    TanggalBayar = firstItem.ktr?.TanggalBayar,
                    StatusPembayaran = firstItem.ktr?.StatusPembayaran,
                    Keterangan = firstItem.ktr?.Keterangan,
                    PaymentMethod = new
                    {
                    ...
                    Resep = new
                    {
                        ResepTebusId = firstItem.rt.ResepTebusId,
