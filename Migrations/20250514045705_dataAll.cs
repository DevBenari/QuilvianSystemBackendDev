        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "text", nullable: true),
                    NoTelepon1 = table.Column<string>(type: "text", nullable: true),
                    NoTelepon2 = table.Column<string>(type: "text", nullable: true),
                    NoTelepon3 = table.Column<string>(type: "text", nullable: true),
